...
public class OrderController {
    ...
    @Operation(summary = "Create a new order",
               description = "Creates a new order with the provided order details and items",
               security = { @SecurityRequirement(name = "api_key") }
               )
    @ApiResponses(value = {
    ...
    @Operation(summary = "Create PayOS payment link",
               description = "Creates a payment link using PayOS payment gateway",
               security = { @SecurityRequirement(name = "api_key") }
               )
    @ApiResponses(value = {
    ...
    @Operation(summary = "Confirm PayOS webhook",
               description = "Confirms and processes PayOS payment webhook notifications",
               security = { @SecurityRequirement(name = "api_key") }
               )
    @ApiResponses(value = {
